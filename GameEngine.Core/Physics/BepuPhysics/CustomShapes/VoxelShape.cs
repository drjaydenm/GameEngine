...
namespace GameEngine.Core.Physics.BepuPhysics.CustomShapes
{
    //Taken from https://github.com/bepu/bepuphysics2/blob/master/Demos/Demos/CustomVoxelCollidableDemo.cs
    ...
    public static class VoxelsRegistration
    {
        public static void RegisterShape(Simulation simulation)
        {
